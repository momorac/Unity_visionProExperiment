...
namespace PolySpatial.Template
{
    public class ARPlaneInteractable : UnityEngine.XR.Interaction.Toolkit.Interactables.XRBaseInteractable
    {
        ...
        bool CheckHandSubsystem()
        {
            ...
            {
#if UNITY_EDITOR
                Debug.LogWarning("Could not find Hand Subsystem. Please ensure that a valid plug-in provider (for example, <b>PolySpatial XR</b>) is enabled in the <b>Project Settings</b> > <b>XR Plug-in Management</b>.");
#else
